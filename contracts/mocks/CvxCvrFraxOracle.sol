...
contract CvxCvrFraxOracle {
    ICurvePool public constant FraxUSDC = ICurvePool(0x1f65856870494B9892d77b105c7f8d861546A27d); // 0xDcEF968d416a41Cdac0ED8702fAC8128A64241A2
    IAggregator public constant FRAX = IAggregator(0xB9E1E3A9feFf48998E45Fa90847ed4D467E8BcfD);   // 100006858
    ...
    function get() public view returns (uint256) {
        ...
        uint256 minStable = min(uint256(100006858), uint256(100024509));
